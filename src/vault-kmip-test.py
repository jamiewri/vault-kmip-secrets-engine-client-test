...
if __name__ == '__main__':
    ...
    with client.ProxyKmipClient(
        ...
        # Commenting out `operation_activate` and `operation_revoke` by default
        #
        # The pykmip library stops you from deleting objects that have been activated.
        # HashiCorp Vault does not support deactivating a object. Including these tests
        # will create managed kmip objects in Vault without being able to delete them.
        #
        # operation_activate
        #try:
